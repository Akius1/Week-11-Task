...
describe("Test for Mutation", () => {
    it("Add an organization", (done) => {
        return request
            .post("/graphql")
            .send({
            query: 'mutation {addOrganization(organization:"Sky",products: ["Transfer", "Withdrawal"],marketValue: 90,address: "Skybank Tower",ceo:"Mr Uche",country: "Nigeria",employees: ["JohnBosco", "Taiwo", "Shola"]){organization, products}}',
        })
            .set("Accept", "Application/json")
            .expect("Content-Type", /json/)
            .expect(200)
